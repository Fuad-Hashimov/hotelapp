...
<body>
    ...
    <div class="min-h-full">
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div class="relative ml-3">
                                ...
                                <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                    ...
                                    <a href="{{ route('admin.logout') }}" class="block px-4 py-2 text-sm text-gray-700"
        ...
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 mt-2">
                <!-- Your content -->
                ...
                <div class="p-5 relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div
                        ...
                        <h1 class="text-gray-50 font-extrabold text-2xl">Hotel </h1>
                    ...
                    <div class="container">
                        <nav aria-label="Page navigation example">
                            <ul class="mt-5 flex items-center justify-center -space-x-px h-10 text-base">
                                <li>
                                    <a href="#"
